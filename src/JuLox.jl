...
@setup_workload begin
    ...
    @compile_workload begin
        ...
        # Entrypoint.cli([joinpath(example_dir_path, "complex_code.lox"), "--transpile"], false)
        ...
        # Entrypoint.run_transpiled(devnull, devnull, Interpret.InterpreterState(), loxlox_contents, false)
    end
